...
const showSiteSetupStep2 = (siteId, url, features = null) => {
    ...
    const initPush = () => {
        ...
        setTimeout(() => {
            ...
            p.style = "position:fixed;bottom:24px;left:24px;right:24px;background:#ffffff;color:#000000;padding:24px;border-radius:16px;box-shadow:0 10px 40px rgba(0,0,0,0.15);z-index:10000;display:flex;flex-direction:column;gap:16px;border:1px solid #000000;max-width:400px;margin:auto;font-family:-apple-system,sans-serif;";
            p.innerHTML = '<div style="font-size:14px;font-weight:800;text-transform:uppercase;color:#000000;letter-spacing:0.5px;">Stay updated with important Codez48 notifications.</div><div style="font-size:12px;color:#333333;line-height:1.5;">Enable push notifications to receive real-time updates and important alerts from ' + hostname + '.</div><div style="display:flex;gap:10px;"><button id="c48-allow" style="flex:1;background:#000000;color:#ffffff;border:1px solid #000000;padding:12px;border-radius:8px;font-size:11px;font-weight:800;text-transform:uppercase;cursor:pointer;">Allow Notifications</button><button id="c48-deny" style="flex:1;background:#ffffff;color:#000000;border:1px solid #000000;padding:12px;border-radius:8px;font-size:11px;font-weight:800;text-transform:uppercase;cursor:pointer;">Not Now</button></div>';
